<template>
    ...
    >
        ...
        <ul class="dd-list" v-if="data.items && data.items.length >= 1">
            <component v-for="(menu_item, index) in data.items" :is="element()" :key="index"
...
import {loadLanguageAsync} from "../../../../locale/index";
    export default {
        ...
        methods: {
            ...
            element() {
                return require(`./ProductItem`).default;
            },
            getTitle(item) {
